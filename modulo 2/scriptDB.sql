...
CREATE SEQUENCE SEQ_HOTEL START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE TABLE QUARTO(
  ...
  CONSTRAINT FK_QUARTO_ID_HOTEL FOREIGN KEY (ID_HOTEL) REFERENCES HOTEL(ID_HOTEL)
);
CREATE SEQUENCE SEQ_QUARTO START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE TABLE RESERVA(
  ...
  CONSTRAINT FK_RESERVA_ID_HOTEL FOREIGN KEY (ID_HOTEL) REFERENCES HOTEL(ID_HOTEL),
  CONSTRAINT FK_RESERVA_ID_QUARTO FOREIGN KEY (ID_QUARTO) REFERENCES QUARTO(ID_QUARTO),
